...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "შეკვეთები",
    subItems: [
      { name: "ყველა შეკვეთა", path: "/orders", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
  ...
  },
  {
    ...
    name: "მიტანა",
    subItems: [
      { name: "მიტანის ზონები", path: "/delivery-zones", pro: false },
    ],
  },
  {
    icon: <PieChartIcon />,
    name: "რეპორტები",
    subItems: [
      { name: "გაყიდვები", path: "/reports/sales", pro: false },
      { name: "ინვენტარი", path: "/reports/inventory", pro: false },
      { name: "აუდიტი", path: "/reports/audit", pro: false },
    ],
  },
];
