...
export default function EditWarehousePage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : "ჩატვირთვის შეცდომა");
      } finally {
        setLoading(false);
      }
    })();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "შეცდომა განახლებისას");
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <PageBreadCrumb pageTitle="საწყობის რედაქტირება" />
